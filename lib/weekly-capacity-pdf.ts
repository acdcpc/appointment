...
export function buildWeeklyCapacitySummaryHtml(input: { weekStartDate: string; weekEndDate: string; reviewedAt: string; unacknowledgedAlertCount: number; rows: Array<{ staffName: string; triageCapacity: number; assignmentCount: number; targetEffectiveAt: string }> }) {
