...
export default function BookingScreen() {
  ...
  return <ScreenContainer className="p-5"><ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
    ...
    <Text style={[styles.eyebrow, { color: colors.primary }]}>DR. ANIL OJHA CHILD CARE</Text><Text style={[styles.title, { color: colors.foreground }]}>Book an appointment</Text><Text style={[styles.subtitle, { color: colors.muted }]}>Available times follow the clinic hours and duration configured by Dr. Ojha’s practice.</Text>
